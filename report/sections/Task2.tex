...
\toprule
{$\nu$} & {Class} & {Precision} & {Recall} & {F1 score} & {Accuracy} \\
\midrule
\multirow{2}{7em}{$\nu = 0.00001$} & Normal (0) & 0.93 	& 0.91 	& 0.92 	& \multirow{2}{2em}{0.89} 	\\
& Anomaly (1) & 0.80 	& 0.84 	& 0.82 	\\ \midrule
\multirow{2}{7em}{$\nu = 0.001$} & Normal (0) & 0.91 	& 0.99 	& 0.95 	& \multirow{2}{2em}{0.93} 	\\
& Anomaly (1) & 0.98 	& 0.76 	& 0.86 	 	\\ \midrule
...
\begin{tabular}{llccc}
\toprule
{Model} & {Accuracy$_{train}$} & {Accuracy$_{test}$} & {Macro F1 score$_{train}$} & {Macro F1 score$_{test}$} \\
\midrule
Normal-Only & 0.93 & 0.74 	& 0.90 	& 0.73 	\\
All-Data & 0.79 & 0.67 	& 0.74 	& 0.65 	\\
Mixed (\SI{10}{\percent} anomalies)	& 0.77 & 0.47 	& 0.63 	& 0.47 	\\
\bottomrule
\end{tabular}
\end{table}
