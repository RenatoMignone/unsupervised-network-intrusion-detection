...
\footnotesize
\centering
\caption{Attack label distribution in the training set. Totally, 5383 (\SI{28.6}{\percent}) samples are anomalies.}
\label{tab:task1_label_distribution}
\begin{tabular}{cccc}
\toprule
{Attack Label} & {Count} & {Percentage} & {Binary label} \\
\midrule
Normal & 13448 & \SI{71.4}{\percent} & Normal (0) \\
DoS & 2913 & \SI{15.5}{\percent} & Anomaly (1) \\
Probe & 2289 & \SI{12.2}{\percent} & Anomaly (1) \\
R2L & 181 & \SI{1.0}{\percent} & Anomaly (1) \\
\bottomrule
\end{tabular}
\end{table}
